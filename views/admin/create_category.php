...
<head>
    ...
    <title>Create new category - Biblio E-Library</title>
    ...
    <div class="offcanvas offcanvas-start bg-light" id="sidebar" tabindex="-1" aria-labelledby="sidebarLabel">
        ...
        <div class="offcanvas-body d-flex flex-column">
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li class="nav-item mb-3">
                    <a href="create_category.php" class="nav-link bg-primary-custom text-white"
                        aria-current="page">Create Category</a>
                </li>
                <li class="nav-item mb-3">
        ...
        <div class="row">
            ...
            <div class="col-md-9 p-4">
                ...
                <form action="" method="POST">
                    ...
                    <button type="submit" class="btn" name="btn">Add Category</button>
                </form>
            </div>
